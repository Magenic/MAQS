...
namespace SeleniumTests
{
    ...
    public class Test
    {
        ...
        public void TheTest()
        {
            ...
            driver.FindElement(By.Id("pw")).SendKeys("123");
            driver.FindElement(By.Id("Login")).Click();
            driver.FindElement(By.Id("AsyncPage")).Click();
            new SelectElement(driver.FindElement(By.Id("Selector"))).SelectByText("Second");
        }
