# AppiumDriverWaitExtensions.RemoveWaitDriver Method 
...
**C#**<br />
``` C#
public static bool RemoveWaitDriver(
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/a28wyd50" target="_blank">Boolean</a><br />True if the wait driver was removed
