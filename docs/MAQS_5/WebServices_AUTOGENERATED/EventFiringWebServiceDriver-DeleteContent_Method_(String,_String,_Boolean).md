# EventFiringWebServiceDriver.DeleteContent Method (String, String, Boolean)
...
**C#**<br />
``` C#
protected override Task<HttpResponseMessage> DeleteContent(
	string requestUri,
