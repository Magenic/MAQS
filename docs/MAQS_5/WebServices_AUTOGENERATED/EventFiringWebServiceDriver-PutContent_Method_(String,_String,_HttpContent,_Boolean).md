# EventFiringWebServiceDriver.PutContent Method (String, String, HttpContent, Boolean)
...
**C#**<br />
``` C#
protected override Task<HttpResponseMessage> PutContent(
	string requestUri,
