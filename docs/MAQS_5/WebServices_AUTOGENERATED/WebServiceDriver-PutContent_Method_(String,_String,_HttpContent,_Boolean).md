# WebServiceDriver.PutContent Method (String, String, HttpContent, Boolean)
...
**C#**<br />
``` C#
protected virtual Task<HttpResponseMessage> PutContent(
	string requestUri,
