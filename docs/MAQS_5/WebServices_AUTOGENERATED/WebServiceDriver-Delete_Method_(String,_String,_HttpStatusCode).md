# WebServiceDriver.Delete Method (String, String, HttpStatusCode)
...
#### Return Value
Type: <a href="http://msdn2.microsoft.com/en-us/library/s1wwdcbf" target="_blank">String</a><br />The response as a string
