...
Execute a web service post</td></tr><tr><td>![Public method](media/pubmethod.gif "Public method")![Code example](media/CodeExample.png "Code example")</td><td><a href="#/MAQS_4/WebServices_AUTOGENERATED/HttpClientWrapper-Post_Method_(String,_String,_HttpContent,_Boolean)">Post(String, String, HttpContent, Boolean)</a></td><td>
...
<a href="#httpclientwrapper.post-method">Back to Top</a>
